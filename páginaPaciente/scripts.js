      ...
      <div class="account-container">
        ...
        <form id="accountForm" class="account-form">
          ...
          <div class="form-group">
            ...
            <input type="email" id="accountEmail" name="email" readonly>
          </div>
          <div class="form-group">
...
`
  ...
  function carregarSecao(secao) {
    ...
    if (secao === 'minha-conta') carregarDadosUsuario();
  ...
  function carregarDadosUsuario() {
    ...
    firebase.firestore().collection('usuarios').doc(user.uid).get()
      .then(doc => {
        ...
        document.getElementById('accountNome').value = user.displayName || dados.nome || '';
        document.getElementById('accountEmail').value = user.email || '';
        document.getElementById('accountTelefone').value = dados.telefone || '';
        document.getElementById('accountDataNascimento').value = dados.dataNascimento || '';
      });
  }
